<template>
    <div class="Footer-container">
        ...
        <div class="Footer-info">
            <!-- <img src="/public/yangban_logo.jpeg" alt="brand-logo-image"> -->
            <p class="Footer-p">양반상회</p>
            <p>전통의 맛을 현대에 담다</p>
            ...
            <a href="https://smartstore.naver.com/yangbansanghoe" target="_blank"><i class="fa-solid fa-store"></i> 스마트스토어</a>
            </div>

        </div>

        <div class="Footer-reserved">
            <p>© 2026 양반상회. All rights reserved.</p>
        </div>
